...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Adarsh Suthar
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">
            Full Stack Developer | Competitve Programmer
        </h3>
        
        <p className="home__description">
        I'm Full Stack developer based in Vadodara , and I'm very passionate and dedicated to my work.
